...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ----- BEGIN: Single, correct SearchView styling block -----
        val searchView = binding.searchView

// ambil EditText internal di SearchView
...
// ----- END: Single, correct SearchView styling block -----
